...
# 6 "c:\\program files (x86)\\microchip\\xc16\\v1.36\\bin\\bin\\../..\\include\\lega-c/stdlib.h" 2 3 4


# 36 "c:\\program files (x86)\\microchip\\xc16\\v1.36\\bin\\bin\\../..\\include\\lega-c/stdlib.h" 3 4
...
# 42 "c:\\program files (x86)\\microchip\\xc16\\v1.36\\bin\\bin\\../..\\support\\PIC24F\\h/p24FJ64GA004.h" 2 3 4
# 647 "c:\\program files (x86)\\microchip\\xc16\\v1.36\\bin\\bin\\../..\\support\\generic\\h/xc.h" 2 3 4
# 31 "h/temperature.h" 2
# 1 "mcc_generated_files/adc1.h" 1
# 32 "h/temperature.h" 2
# 56 "h/temperature.h"
typedef enum {
    THERM_NO_CHANGE,
    THERM_ALERT,
...
int main(void)
{
    ...
    ADC1_Initialize();
    ProtocolInit();
    { __delay32( (unsigned long) (((unsigned long long) 500)*(32000000UL/2)/1000ULL)); };
    ...
    while (1)
    {
        uint8_t buttonEvent, temperature;
        protocol_event_t proto_event;
        protocol_data_t proto_data;
        therm_event_t therm_event;
        ...
        switch(proto_event)
        {
            ...
            case PROTO_SYS_RESET: ProtocolClose(); { __delay32( (unsigned long) (((unsigned long long) 500)*(32000000UL/2)/1000ULL)); }; SysReset(); break;
            case PROTO_TEST_ON: LoadsInit(); test_mode = 1; do{uint8_t i; for(i = 0; i < 9; i++) LedBlink(i); }while(0); break;
            case PROTO_TEST_OFF: LoadsInit(); test_mode = 0; do{uint8_t i; for(i = 0; i < 9; i++) LedOff(i); }while(0); break;
            default: break;
        }
