...
# 29 "src/fault.c" 2
# 50 "src/fault.c"
static volatile _Bool fault_flags[4];
...
uint8_t FaultCheck(void)
{
    uint8_t faultStatus = 0, fault_id;
    ;
...
static _Bool FaultInput(uint8_t fault_id)
{
    switch(fault_id)
    {
        case 1: return (_Bool)(PORTCbits.RC7);
        case 0: return (_Bool)(PORTCbits.RC6);
        case 3: return (_Bool)(PORTBbits.RB9);
        case 2: return (_Bool)(PORTCbits.RC9);
        default: return 0;
    }
}
...
static void FaultClear(uint8_t fault_id)
{
    switch(fault_id)
    {
        case 1:
            LATBbits.LATB11 = 0;
            { __delay32( (unsigned long) (((unsigned long long) 50)*(32000000UL/2)/1000000ULL)); };
            ;
            LATBbits.LATB11 = 1;
            break;
