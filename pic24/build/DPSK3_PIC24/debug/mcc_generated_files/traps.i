...
# 50 "mcc_generated_files/traps.c" 2
# 58 "mcc_generated_files/traps.c"
...
void __attribute__((interrupt,no_auto_psv)) __attribute__((noreturn)) _OscillatorFail(void)
{
    INTCON1bits.OSCFAIL = 0;
    TRAPS_halt_on_error(TRAPS_OSC_FAIL);
}

void __attribute__((interrupt,no_auto_psv)) __attribute__((noreturn)) _StackError(void)
{
...
void __attribute__((interrupt,no_auto_psv)) __attribute__((noreturn)) _AddressError(void)
{
    INTCON1bits.ADDRERR = 0;
    TRAPS_halt_on_error(TRAPS_ADDRESS_ERR);
}

void __attribute__((interrupt,no_auto_psv)) __attribute__((noreturn)) _MathError(void)
{
