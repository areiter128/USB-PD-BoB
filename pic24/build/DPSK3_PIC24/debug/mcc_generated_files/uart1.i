...
# 1 "<command-line>"
# 1 "mcc_generated_files/uart1.c"
# 49 "mcc_generated_files/uart1.c"
...
# 54 "mcc_generated_files/uart1.h" 2
# 1 "c:\\program files (x86)\\microchip\\xc16\\v1.36\\bin\\bin\\../..\\include\\lega-c/stdint.h" 1 3 4
...
# 61 "mcc_generated_files/uart1.c"
typedef union
{
    struct
    {
...
# 118 "mcc_generated_files/uart1.c"
static uint8_t uart1_txByteQ[32] ;
static uint8_t uart1_rxByteQ[32] ;
...
void UART1_Initialize (void)
{
   ...
   uart1_obj.rxStatus.s.empty = 1;
   uart1_obj.txStatus.s.empty = 1;
   uart1_obj.txStatus.s.full = 0;
   uart1_obj.rxStatus.s.full = 0;
}
...
void __attribute__ ( ( interrupt, no_auto_psv ) ) _U1TXInterrupt ( void )
{
    ...
    while(!(U1STAbits.UTXBF == 1))
    {
        ...
        if(uart1_obj.txHead == (uart1_txByteQ + 32))
        {
            uart1_obj.txHead = uart1_txByteQ;
        }
...
void __attribute__ ( ( interrupt, no_auto_psv ) ) _U1RXInterrupt( void )
{
    ...
    while((U1STAbits.URXDA == 1))
    {
        ...
        *uart1_obj.rxTail = U1RXREG;
        ...
        if(uart1_obj.rxTail == (uart1_rxByteQ + 32))
        {
            uart1_obj.rxTail = uart1_rxByteQ;
        }

        uart1_obj.rxStatus.s.empty = 0;

        if(uart1_obj.rxTail == uart1_obj.rxHead)
        {

            uart1_obj.rxStatus.s.full = 1;
            break;
        }
...
uint8_t UART1_Read( void)
{
    ...
    if (uart1_obj.rxHead == (uart1_rxByteQ + 32))
    {
        uart1_obj.rxHead = uart1_rxByteQ;
    }
...
void UART1_Write( const uint8_t byte)
{
    ...
    *uart1_obj.txTail = byte;
    ...
    if (uart1_obj.txTail == (uart1_txByteQ + 32))
    {
        uart1_obj.txTail = uart1_txByteQ;
    }

    uart1_obj.txStatus.s.empty = 0;

    if (uart1_obj.txHead == uart1_obj.txTail)
    {
        uart1_obj.txStatus.s.full = 1;
    }
...
uint8_t UART1_Peek(uint16_t offset)
{
    if( (uart1_obj.rxHead + offset) > (uart1_rxByteQ + 32))
    {
      return uart1_rxByteQ[offset - (uart1_rxByteQ + 32 - uart1_obj.rxHead)];
    }
    else
    {
...
unsigned int UART1_ReceiveBufferSizeGet(void)
{
    if(!uart1_obj.rxStatus.s.full)
    {
        ...
        {
            return(32 - (uart1_obj.rxTail - uart1_obj.rxHead));
        }
    }
    return 0;
}
...
unsigned int UART1_TransmitBufferSizeGet(void)
{
    if(!uart1_obj.txStatus.s.full)
    {
        ...
        {
            return(32 - (uart1_obj.txTail - uart1_obj.txHead));
        }
    }
    return 0;
}
