...
# 70 "mcc_generated_files/mcc.c" 2
...
void OSCILLATOR_Initialize(void)
{
    ...
    __builtin_write_OSCCONH((uint8_t) ((0x0100 >> 0x00000008) & 0x00FF));
    __builtin_write_OSCCONL((uint8_t) ((0x0100 | 0x00000001) & 0xFF));
