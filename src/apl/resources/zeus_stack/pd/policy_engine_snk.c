...
void PE_SnkRunStateMachine (UINT8 u8PortNum , UINT8 *pu8DataBuf , UINT8 u8SOPType ,UINT32 u32Header)
{
    ...
    switch (gasPolicy_Engine[u8PortNum].ePEState)
    {
        ...
        {         
            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_STARTUP: Enterted the state\r\n");
        ...
        case ePE_SNK_DISCOVERY:
        {
            ...
            if ((DPM_GetVBUSVoltage(u8PortNum) == PWRCTRL_VBUS_5V) && \
                (u8TypeCState == TYPEC_ATTACHED_SNK))
            {
			  	/* Enable Power fault thresholds for PWRCTRL_VBUS_5V to detect Power faults*/
        ...
        case ePE_SNK_WAIT_FOR_CAPABILITIES:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {                   
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_WAIT_FOR_CAPABILITIES: Enterted the state\r\n");
        ...
        {            
            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_EVALUATE_CAPABILITY: Enterted the state\r\n");
        ...
        case ePE_SNK_SELECT_CAPABILITY:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                case ePE_SNK_SELECT_CAPABILITY_SEND_REQ_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_SELECT_CAPABILITY: Enterted the state\r\n");
        ...
        case ePE_SNK_TRANSITION_SINK:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {                    
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_TRANSITION_SINK: Enterted the state\r\n");
        ...
        case ePE_SNK_READY:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {                    
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_READY: Enterted the state\r\n");
        ...
        case ePE_SNK_HARD_RESET:
        {
           ...
           {           
               ...
               { 
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_HARD_RESET_SEND_SS: Enterted the state\r\n");
        ...
        {            
           ...
           {                  
               case ePE_SNK_TRANSITION_TO_DEFAULT_ENTRY_SS:
               {
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_TRANSITION_TO_DEFAULT: Enterted the state\r\n");
               ...
               {    
                    ...
                    TypeC_ConfigureVBUSThr(u8PortNum, PWRCTRL_VBUS_0V, TYPEC_CONFIG_NON_PWR_FAULT_THR);
               ...
               {                     
                    ...
                    {      
					  	/*Configuring for VBUS threshold to detect PWRCTRL_VBUS_5V*/
        ...
        {              
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_GIVE_SINK_CAP: Enterted the state\r\n");
        ...
        case ePE_SNK_SOFT_RESET:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                case ePE_SNK_SOFT_RESET_SEND_ACCEPT_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_SOFT_RESET: Enterted the state\r\n");
        ...
        case ePE_SNK_SEND_SOFT_RESET:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                case ePE_SNK_SEND_SOFT_RESET_ENTRY_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_SEND_SOFT_RESET: Enterted the state\r\n");
