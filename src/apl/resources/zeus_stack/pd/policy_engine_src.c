...
void PE_SrcRunStateMachine(UINT8 u8PortNum , UINT8 *pu8DataBuf , UINT8 u8SOPType ,UINT32 u32Header)
{
    ...
    if(((TYPEC_UNATTACHED_SRC == u8TypeCState) && (ePE_SRC_STARTUP != gasPolicy_Engine[u8PortNum].ePEState)) ||
            (port_pdo_update_required[u8PortNum]))
    {
        ...
        if ((port_pdo_update_required[u8PortNum] == PDO_UPDATE_CAPS_RESET) && 
            (TYPEC_ATTACHED_SRC == u8TypeCState))
        {
            /* Force a hard reset if connected */
        ...
        port_pdo_update_required[u8PortNum] = PDO_NO_UPDATE;
    }
    ...
    switch(gasPolicy_Engine[u8PortNum].ePEState)
    {
        ...
        case ePE_SRC_STARTUP:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_STARTUP-ENTRY_SS\r\n");
                ...
                case ePE_SRC_STARTUP_IDLE_SS:
                {
                    if(( TYPEC_ATTACHED_SRC == u8TypeCState) && (TYPEC_ATTACHED_SRC_RUN_SM_SS == u8TypeCSubState))
                    {
                        ...
                        { 
                            ...
                            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_STARTUP-IDLE_SS: Device Attached\r\n");
                        ...
                        else
                        {
                            ...
                            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_STARTUP-IDLE_SS: E-Cable and Device Attached\r\n");
            ...
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                case ePE_SRC_SEND_CAP_ENTRY_SS:
                {
                    ...
                    else
                    {
                        ...
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_SEND_CAP-ENTRY_SS: Send Source Capabilities\r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_SEND_CAP-GOODCRC_RECEIVED_SS\r\n");
                ...
                case ePE_SRC_SEND_CAP_SENDER_RESPONSE_TIMEOUT_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_SEND_CAP-SENDER_RESPONSE_TIMEOUT_SS\r\n");
                    gasPolicy_Engine[u8PortNum].ePEState = ePE_SRC_HARD_RESET;
                    gasPolicy_Engine[u8PortNum].ePESubState = ePE_SRC_HARD_RESET_ENTRY_SS;
                    break;  
                }
        ...
        case ePE_SRC_NEGOTIATE_CAPABILITY:
        {
            ...
            if(DPM_VALID_REQUEST == DPM_ValidateRequest(u8PortNum, (UINT16)u32Header, pu8DataBuf))
            {
                ...
                HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_NEGOTIATE_CAPABILITY: Request is Valid\r\n");
            ...
            else
            {
                ...
                HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_NEGOTIATE_CAPABILITY: Request is Invalid\r\n"); 
            ...
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                case ePE_SRC_TRANSITION_SUPPLY_EXIT_SS:
                {
                    ...
                    if(u16DrivenVoltage == DPM_GetVBUSVoltage(u8PortNum))
                    {
                        ...
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_TRANSITION_SUPPLY-EXIT_SS\r\n");
        ...
        case ePE_SRC_READY:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_READY-ENTRY_SS\r\n");
					...
					DPM_ConfigurePwrFault(u8PortNum);
        ...
        case ePE_SRC_DISCOVERY:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_DISCOVERY-ENTRY_SS\r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_DISCOVERY-EXIT_SS\r\n");
        ...
        case ePE_SRC_HARD_RESET:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_HARD_RESET-ENTRY_SS\r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_HARD_RESET-EXIT_SS\r\n");
         ...
         case ePE_SRC_HARD_RESET_RECEIVED:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_HARD_RESET_RECEIVED-ENTRY_SS\r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_HARD_RESET_RECEIVED-EXIT_SS\r\n");
                    gasPolicy_Engine[u8PortNum].ePEState = ePE_SRC_TRANSITION_TO_DEFAULT;
                    gasPolicy_Engine[u8PortNum].ePESubState = ePE_SRC_TRANSITION_TO_DEFAULT_ENTRY_SS;  
                    break;
                }
        ...
        case ePE_SRC_TRANSITION_TO_DEFAULT:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_TRANSITION_TO_DEFAULT-ENTRY_SS\r\n");
					...
					/* Turn Off VBus */
                    DPM_VBusOnOff(u8PortNum, DPM_VBUS_OFF);
                ...
                case ePE_SRC_TRANSITION_TO_DEFAULT_VSAFE0V_SS:
                {
                    ...
                    if(PWRCTRL_VBUS_0V == DPM_GetVBUSVoltage(u8PortNum))
                    {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_TRANSITION_TO_DEFAULT-POWER_ON_SS\r\n");
					...
					/* Turn On VBus */
                    DPM_VBusOnOff(u8PortNum, DPM_VBUS_ON);
                ...
                case ePE_SRC_TRANSITION_TO_DEFAULT_VBUS_CHECK_SS:
                {
                    ...
                    {
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_TRANSITION_TO_DEFAULT-EXIT_SS\r\n");
#ifdef CONFIG_HOOK_DEBUG_MSG                        
						...
						/* Enable Power fault thresholds for PWRCTRL_VBUS_5V*/
                ...
                case ePE_SRC_TRANSITION_TO_DEFAULT_EXIT_SS:
                {
                    ...
                    gasPolicy_Engine[u8PortNum].u8PENoResponseTimerID = PDTimer_Start (
                                                        (CONFIG_PE_NORESPONSE_TIMEOUT_SECS),
        ...
        case ePE_SRC_SEND_SOFT_RESET:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"ePE_SRC_SEND_SOFT_RESET-SOP_SS\r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_SEND_SOFT_RESET-ENTRY_SS\r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_SEND_SOFT_RESET-GOODCRC_RECEIVED_SS\r\n");
                    gasPolicy_Engine[u8PortNum].u8PETimerID = PDTimer_Start (
                                                            CONFIG_PE_SENDERRESPONSE_TIMEOUT_MS,
                                                            PE_SubStateChange_TimerCB,u8PortNum,  
                ...
                {
					/* Sender Response timer timed out */
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_SEND_SOFT_RESET-SENDER_RESPONSE_TIMEDOUT\r\n");
                    gasPolicy_Engine[u8PortNum].ePEState = ePE_SRC_HARD_RESET;
                    gasPolicy_Engine[u8PortNum].ePESubState = ePE_SRC_HARD_RESET_ENTRY_SS; 
                    break;
                }
        ...
        case ePE_SRC_SOFT_RESET:
        {
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"ePE_SRC_SOFT_RESET-ENTRY_SS\r\n");
        ...
        case ePE_SRC_VDM_IDENTITY_REQUEST:
        {
            ...
            switch(gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_VDM_IDENTITY_REQUEST-ENTRY_SS\r\n");
                ...
                case ePE_SRC_VDM_IDENTITY_REQUEST_GOODCRC_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_VDM_IDENTITY_REQUEST-GOODCRC_SS\r\n");
        ...
        {
            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_VDM_IDENTITY_ACKED\r\n");
        ...
        {
            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SRC_VDM_IDENTITY_NAKED\r\n");
