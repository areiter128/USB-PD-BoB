...
void PE_RunStateMachine (UINT8 u8PortNum)
{
#if __XC16__
    /* Receive Data Buffer */ 
    UINT8 u8DataBuf[260] __attribute__(( aligned(2) )) = {SET_TO_ZERO};
#else
    /* Receive Data Buffer */ 
    ...
    /* Received Msg Header */
    UINT32 u32Header = SET_TO_ZERO;
    UINT8 u8RetVal = PRL_RET_NO_MSG_RCVD;
...
UINT8 PE_ValidateMessage (UINT8 u8PortNum, UINT32 u32Header)
{
    ...
    UINT8 u8ChkMsgSupport = PE_IsMsgUnsupported (u8PortNum, u32Header);
    ...
    if (PE_UNSUPPORTED_MSG == u8ChkMsgSupport)
    {
           ...
           (ePE_SNK_READY == gasPolicy_Engine[u8PortNum].ePEState))
        {
            ...
            if (u8ChkMsgSupport == PE_UNSUPPORTED_MSG)
            {
            ...
            switch (PRL_GET_MESSAGE_TYPE (u32Header))
            {
                ...
                case PE_DATA_REQUEST:
                {
                       ...
                       ePE_SRC_READY == gasPolicy_Engine[u8PortNum].ePEState)
                    {
                        ...
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_DATA_REQUEST: Source Capability message received\r\n");
                    }
                ...
                case PE_DATA_BIST:
                {
				  	if (((ePE_SNK_READY == gasPolicy_Engine[u8PortNum].ePEState) || \
						(ePE_SRC_READY == gasPolicy_Engine[u8PortNum].ePEState)) &&	\
						(PWRCTRL_VBUS_5V == DPM_GetVBUSVoltage(u8PortNum)))
					{
                ...
                case PE_EXT_FW_UPDATE_REQUEST:
                {
                    ...
                    {
                        if(TRUE == CONFIG_HOOK_IS_PDFU_ALLOWED_NOW())
                        {
            ...
            switch (PRL_GET_MESSAGE_TYPE (u32Header))
            {
                case PE_CTRL_ACCEPT:
                {
                        ...
                        gasPolicy_Engine[u8PortNum].ePESubState)
                    {
                        ...
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_SELECT_CAPABILITY: Accept Msg Received\r\n");
                       PE_KillPolicyEngineTimer (u8PortNum);
                    ...
                    /*Accept message received for soft reset sent by Sink*/
                             ...
                             gasPolicy_Engine[u8PortNum].ePESubState)
                    {
                         HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SNK_SEND_SOFT_RESET: Accept Msg received\r\n");
                        /*kill the timer CONFIG_PE_SENDER_RESPONSE_TIMEOUTID*/
                         PE_KillPolicyEngineTimer (u8PortNum);
                    ...
                    {
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_CTRL_ACCEPT: SenderResponse Timer Killed\r\n");
                        PE_KillPolicyEngineTimer (u8PortNum);
                ...
                case PE_CTRL_GET_SOURCE_CAP:
                {
                    if (ePE_SRC_READY == gasPolicy_Engine[u8PortNum].ePEState)
                    {
                        HOOK_DEBUG_PORT_STR (u8PortNum,"PE_CTRL_GET_SOURCE_CAP: Get Source Cap Received\r\n");
                        gasPolicy_Engine[u8PortNum].ePEState = ePE_SRC_SEND_CAPABILITIES;
                        gasPolicy_Engine[u8PortNum].ePESubState = ePE_SRC_SEND_CAP_ENTRY_SS;
                    }
                    else
    ...
    switch (gasPolicy_Engine[u8PortNum].ePEState)
    {
       ...
       case ePE_SEND_NOT_SUPPORTED:
       {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_SEND_NOT_SUPPORTED: Enterted the state\r\n");
       ...
       case ePE_SEND_REJECT:
       {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"ePE_SEND_REJECT: Enterted the state\r\n");
        ...
        case ePE_VCS_EVALUATE_SWAP:
        {
            ...
            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_VCS_EVALUATE_SWAP: Enterted the state\r\n");
        ...
        case ePE_VCS_ACCEPT_SWAP:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_VCS_ACCEPT_SWAP-SEND_ACCEPT_SS: Enterted the SubState \r\n");
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"PE_VCS_ACCEPT_SWAP-ACCEPT_SENT_SS: Enterted the SubState \r\n");
        ...
        case ePE_VCS_WAIT_FOR_VCONN:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                     HOOK_DEBUG_PORT_STR (u8PortNum,"PE_VCS_WAIT_FOR_VCONN-START_TIMER_SS: Enterted the SubState \r\n");
        ...
        {          
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                case ePE_VCS_TURN_OFF_VCONN_ENTRY_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR(u8PortNum,"PE_VCS_TURN_OFF_VCONN: Enterted the state\r\n");
        ...
        case ePE_VCS_TURN_ON_VCONN:
        {
            ...
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                case ePE_VCS_TURN_ON_VCONN_ENTRY_SS:
                {
                    ...
                    HOOK_DEBUG_PORT_STR(u8PortNum,"PE_VCS_TURN_ON_VCONN: Enterted the state\r\n");
        ...
        case ePE_VCS_SEND_PS_RDY:
        {
            switch (gasPolicy_Engine[u8PortNum].ePESubState)
            {
                ...
                {
                    HOOK_DEBUG_PORT_STR (u8PortNum,"ePE_VCS_SEND_PS_RDY-ENTRY_SS: Enterted the SubState \r\n");
                    /*Send PS_RDY message*/
                    u8TransmitSOP = PRL_SOP_TYPE;
        ...
        {
            HOOK_DEBUG_PORT_STR (u8PortNum,"PE_RESP_VDM_GET_IDENTITY: Entered the state\r\n");
  ...
  UINT8 u8TxFailedState, UINT8 u8TxFailedSubState)
{
    ...
    switch (gasPRL[u8PortNum].u8TxStateISR)
    {
        ...
        case PRL_TX_FAILED_ST:
        {
          ...
          /*Workaround for EOP protocol layer issue*/
//        case PRL_TX_EOP_ST:
//        {
//            gasPolicy_Engine[u8PortNum].ePEState = (ePolicyState) u8TXDoneState;
//            gasPolicy_Engine[u8PortNum].ePESubState = (ePolicySubState) u8TxDoneSubState;
...
void PE_SubStateChangeAndTimeoutValidateCB(UINT8 u8PortNum, UINT8 u8PESubState)
{
    ...
    if(NULL == gasPolicy_Engine[u8PortNum].u32TimeoutMsgHeader)
    {
