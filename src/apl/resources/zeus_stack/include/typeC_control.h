...
#define TYPEC_VBUS_DB_STS           TYPEC_CABLE_PLUG_CSR_BASE_ADDR + 0x0C
...
/* To get voltage from VBUS Threshold value */
#define TYPEC_GET_VOLTAGE_FRM_VBUS_THR(u16VBUSThr)	\
			(UINT16)(u16VBUSThr * TYPEC_VBUS_THRX_UNITS_MILLI_V)
...
/*************************************************************/
/*This Define results in 2ms of debounce for VCONN OCS. Same Value is used in Standalone Mode as well*/
#define TYPEC_VCONN_DEBOUNCE	    2
...
#define TYPEC_VBUS_PRESENCE_MASK	    (BIT(6) | BIT(5) | BIT(4))
#define TYPEC_VBUS_PRESENCE_POS         4

#define TYPEC_VBUS_0V       0
#define TYPEC_VBUS_5V       BIT(4)
#define TYPEC_VBUS_9V       BIT(5)
#define TYPEC_VBUS_15V     (BIT(5) | BIT(4))
#define TYPEC_VBUS_20V      BIT(6)              
...
*/
typedef struct _TypeCcontrol CONFIG_STRUCT_PACKED_START
{
  UINT8 u8TypeCState;
...
}CONFIG_STRUCT_PACKED_END TYPEC_CONTROL;
...
void TypeC_EnablePowerFaultThr(UINT8 u8PortNum, UINT16 u16Voltage);
