...
/**************************************************************************************************
    ...
    Function:
        void PE_FwUpdtNotifyUnexpected(UINT8 u8MsgType,UINT8 u8PortNum)

    Summary:
        This function posts the errUNEXPECTED_REQUEST response for the latest request.
    ...
    Input:
        UINT8 u8PortNum - Port in which the PDFU is happening
        UINT8 u8MsgType - Message Type of the PDFU Request.
...
//void PE_FwUpdtNotifyUnexpected(UINT8 u8PortNum);
