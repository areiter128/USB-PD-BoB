...
#define PRL_PORT_DATA_ROLE_BIT_POS					5		/* Port Data Role - Bit5 */
...
typedef void (*PRLTxCallback)(UINT8 u8PortNum, UINT8 u8TxDonePEst, UINT8 u8TxDonePESubst,
							  UINT8 u8TxFailedPEst, UINT8 u8TxFailedPESubst);
...
typedef struct  _PROTOCOL_LAYER CONFIG_STRUCT_PACKED_START
{
...
} CONFIG_STRUCT_PACKED_END PROTOCOL_LAYER_STRUCT;

/*************************************************************************************************/

typedef struct  _CHUNK CONFIG_STRUCT_PACKED_START
{
...
} CONFIG_STRUCT_PACKED_END PRL_CHUNK_STRUCT;

/*************************************************************************************************/

typedef struct _PRL_TX_DESC CONFIG_STRUCT_PACKED_START
{
	UINT8	u8TimerID;
	UINT8	u8TxDoneSt;
	UINT8	u8TxAbortSt;
	UINT8	u8TxFailSt;
	PRLTxCallback	pfnTxCallback;
} CONFIG_STRUCT_PACKED_END PRL_TRANSMITTER_DESC;

/*************************************************************************************************/
/* In the order of struct element, Rx FIFO is filled on message reception*/
typedef struct _PRL_RECV CONFIG_STRUCT_PACKED_START
{
	UINT8	u8RxNbytes;
...
} CONFIG_STRUCT_PACKED_END PRL_RECVBUFF;

/*************************************************************************************************/
typedef struct _PRL_EXTENDED_MESSAGE_BUFF CONFIG_STRUCT_PACKED_START
{
	UINT16 	u16Header;
...
} CONFIG_STRUCT_PACKED_END PRL_EXTMSG_BUFF;
...
/**************************************************************************************************
    ...
    Input:
		...
		u8PESubstate - Place holder parameter to maintain TimerCB define format.
